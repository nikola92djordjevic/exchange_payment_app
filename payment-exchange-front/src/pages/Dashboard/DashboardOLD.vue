    ...
    <div class="dashboard-page">
      ...
      <v-row>
        <v-col lg="4" sm="6" md="5" cols="12">
          <v-card class="mx-1 mb-1" style="height: 338px">
            <v-card-title class="flex-nowrap pa-6 pb-1">
              <p class="text-truncate">Current CashRegister balance</p>
            </v-card-title>
            <v-card-text class="pa-0 pt-0 mb-0">
              <v-row no-gutters>
                <v-col cols="12">
                  <ApexChart
                    height="250"
                    type="pie"
                    class="mt-3"
                    :options="this.apexPie1.options"
                    :series="getApexPieSeries()"
                  ></ApexChart>
                </v-col>
              </v-row>
            </v-card-text>
        ...
        <v-col lg="12" sm="12" md="12" cols="12">
          <v-card class="mx-1 mb-1">
            <v-card-title class="pa-6 pb-3">
              ...
              <v-row>
                <v-col>
                  <v-icon x-large>mdi-desktop-tower-monitor</v-icon>

                  <p>Work place: Open</p>
                  <v-spacer></v-spacer>
                  <p>Date: {{ this.workPlace.timestampOfOpen }}</p>
              ...
              <v-row>
                ...
                <v-col>
                  ...
                  <p>CashRegisterId: {{ this.workPlace.cashRegisterId }}</p>
                  <v-spacer></v-spacer>

                  <p>CashRegister Name: {{ this.cashRegisterBalance.cashRegisterName }}</p>
                </v-col>
              </v-row>
            </v-card-title>
            <v-card-text class="pa-6 pt-0">
              <v-card>
                ...
                <v-container
                  v-for="currencyBalance in this.cashRegisterBalance.balanceList"
                  :key="currencyBalance"
                ...
                >
                  ...
                  <span
                    class="font-weight-medium card-dark-grey"
                    style="font-size: 24px"
                  >{{ currencyBalance.currencyCode }}</span>
                    </v-col>
                    <v-col cols="6">
                  <span
                    class="font-weight-medium card-dark-grey"
                    style="font-size: 24px"
                  >{{ currencyBalance.balance }}</span>
                    </v-col>
                  </v-row>
                </v-container>
              </v-card>
              ...
              <table class="table align-items-center">
                <tbody>
                <tr v-for="(balance, index) in this.cashRegisterBalance.balanceList" :key="index">
                  <td class="w-30">
                    <div class="px-2 py-1 d-flex align-items-center">
                      <div class="ms-4">
                        <p class="mb-0 text-xs font-weight-bold">Currency:</p>
                        <h6 class="mb-0 text-sm">{{ getCurrencyRecord(balance.currencyCode) }}</h6>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div class="text-center">
                      ...
                      <h6 class="mb-0 text-sm">{{ balance.currencyCode }}</h6>
                    </div>
                  </td>
                  <td>
                    <div class="text-center">
                  ...
                  <td class="text-sm align-middle">
                    <div class="text-center col">
                      ...
                      <h6 class="mb-0 text-sm">{{ balance.balance }}</h6>
                    </div>
                  </td>
                </tr>
                </tbody>
          ...
          <v-card class="mx-1 mb-1">
            <v-card-title class="pa-6 pb-0">
              <v-row no-gutters>
                ...
                >
                  <v-icon size="28" color="warning">mdi-circle-medium
                  </v-icon
                  >
                  <span
                  ...
                  >Tablet</span
                  >
                  <v-icon size="18" color="primary">mdi-circle-medium
                  </v-icon
                  >
                  <span
                    class="card-dark-grey font-weight-regular mr-3"
                  ...
                  >Mobile</span
                  >
                  <v-icon size="18" color="#B1BCFF">mdi-circle-medium
                  </v-icon
                  >
                  <span
            ...
            <v-card-text class="pa-6 pt-0">
              ...
              <v-row no-gutters class="justify-space-between">
                ...
                <div>
                  <div class="subtext">
                    330
                    <v-icon color="error"> mdi-arrow-bottom-right</v-icon>
                  </div>
